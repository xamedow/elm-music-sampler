...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.I === 'ClickedTick') {
			var nextTicks = A3(elm_community$list_extra$List$Extra$setAt, msg.F.V, msg.F.ak, model.v);
...
var author$project$Main$viewTicks = function (model) {
	return A2(
		...
		A2(elm$core$List$indexedMap, author$project$Main$viewTick, model.v));
};
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{av: author$project$Main$initialModel, aD: author$project$Main$update, aF: author$project$Main$view});
